...
define config.name = _("Lost in Transition")
...
define gui.about = _p("""Written by Shane George ({a=https://twitter.com/hyperstn}@hyperstn{/a}) 2019.
""")
...
define build.name = "LostinTransition"
...
define config.save_directory = "LostinTransition-1573701232"
